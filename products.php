<?php
$page_title = "Products | Medisky Lifesciences Pvt. Ltd.";
$page_description = "Full product portfolio from Medisky Lifesciences — parenteral nutrition, iron therapy, plasma volume expanders and surgical consumables.";
  ...
  <div class="container-xl">
    <div class="row g-4 align-items-center">
      <div class="col-lg-7">
        ...
        <h1 style="max-width:none;">Seven Clinical Products Across Four Therapeutic Areas</h1>
        <p class="lede" style="max-width:none;">All prescription products are marketed for use under medical supervision only. Formulated to ESPEN and international pharmacopoeial standards for ICU, surgical, and hospital procurement.</p>
      </div>
      <div class="col-lg-5">
...
<section style="background:#f8fafc; border-bottom:1px solid var(--line); padding:14px 0;">
  <div class="container-xl">
    <div class="d-flex flex-wrap justify-content-center gap-2">
      <a href="#nutrition" class="portfolio-filter-btn">🧪 Parenteral &amp; Oral Nutrition</a>
      <a href="#minerals" class="portfolio-filter-btn">⚡ Trace Elements &amp; Iron</a>
      <a href="#volume" class="portfolio-filter-btn">💧 Plasma Expander</a>
      <a href="#surgical" class="portfolio-filter-btn">🧤 Surgical Consumables</a>
    </div>
  </div>
</section>
...
<section class="section" id="nutrition">
  <div class="container-xl">
    <div class="section-head">
      <h2>Parenteral &amp; Oral Nutrition</h2>
    </div>
...
<!-- MINERALS / IRON -->
<section class="section section-alt" id="minerals">
  <div class="container-xl">
    <div class="section-head">
      <h2>Trace Elements &amp; Iron Therapy</h2>
    </div>
...
<section class="section" id="volume">
  <div class="container-xl">
    <div class="section-head">
      <h2>Plasma Volume Replacement</h2>
    </div>
...
<!-- SURGICAL -->
<section class="section section-alt" id="surgical">
  <div class="container-xl">
    <div class="section-head">
      <h2>Surgical &amp; Examination Consumables</h2>
    </div>
...
<section class="section">
  <div class="container-xl">
    <div class="section-head">
      <h2>Product Summary Matrix</h2>
    </div>
    <div class="table-responsive">
      <table class="table table-hover table-bordered align-middle" style="background:#fff; font-size:0.9rem;">
        <thead style="background:var(--navy); color:#fff;">
          <tr>
            <th>Product Name</th>
            <th>Therapeutic Category</th>
            <th>Key Composition &amp; Strength</th>
            <th>Pack Size / Presentation</th>
        ...
        <tbody>
          <tr>
            ...
            <td>250 ml Bottle</td>
            <td>ICU nutrition, burns, recovery, IUGR pregnancy</td>
            <td class="text-center"><a href="product-aminosky.php" class="btn btn-sm btn-outline-primary">Details</a></td>
          </tr>
          <tr>
            ...
            <td class="text-center"><a href="product-glutasky.php" class="btn btn-sm btn-outline-primary">Details</a></td>
          </tr>
          <tr>
            ...
            <td class="text-center"><a href="product-lglutasky-plus.php" class="btn btn-sm btn-outline-primary">Details</a></td>
          </tr>
          <tr>
            <td><strong>ZincFlow</strong> <span class="rx-flag">Rx</span></td>
            <td>Trace Element Therapy</td>
            <td>Zinc Chloride Injection IP 1 mg/ml</td>
            <td>10 ml Vial</td>
            <td>ESPEN 2022 trace element, wound healing, sepsis</td>
            <td class="text-center"><a href="product-zincflow.php" class="btn btn-sm btn-outline-primary">Details</a></td>
          </tr>
          <tr>
            ...
            <td class="text-center"><a href="product-ferric-cm.php" class="btn btn-sm btn-outline-primary">Details</a></td>
          </tr>
          <tr>
            ...
            <td class="text-center"><a href="product-tetravan.php" class="btn btn-sm btn-outline-primary">Details</a></td>
          </tr>
          <tr>
            <td><strong>Touch-Med</strong></td>
            <td>Surgical Consumables</td>
            <td>Nitrile Examination Gloves (Powder-Free, Latex-Free)</td>
            <td>M 100pcs / G30 Pack</td>
            <td>AQL 1.5, clinical &amp; surgical examination</td>
            <td class="text-center"><a href="product-touch-med.php" class="btn btn-sm btn-outline-primary">Details</a></td>
          </tr>
        </tbody>
      </table>
    </div>
...
<section class="cta-band">
  <div class="container-xl d-flex flex-wrap justify-content-between align-items-center gap-4">
    <div>
      <h2>Need product literature or a supply quote?</h2>
      <p>We can share full prescribing information, MRP and stockist terms on WhatsApp.</p>
    </div>
